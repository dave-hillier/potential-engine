#!/usr/bin/env python3
"""Data loader: Author statistics for a specific repository.

Usage: python authors.json.py <repo_name>
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python authors.json.py <repo_name>", file=sys.stderr)
        sys.exit(1)
