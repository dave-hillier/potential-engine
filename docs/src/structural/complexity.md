...
```js
const data = FileAttachment("../data/complexity-distribution.json.py", {cache: false}).json({
  command: ["../../../../venv/bin/python3", "../data/complexity-distribution.json.py", selectedRepo]
});
```
